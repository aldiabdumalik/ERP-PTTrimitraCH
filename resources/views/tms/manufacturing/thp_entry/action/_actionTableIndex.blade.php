<div class="btn-group dropright">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item text-primary thp-act-view" href="javascript:void(0)" data-thp="{{ $data->id_thp }}"><i class="fa fa-eye"></i> View</a>
        @if ($data->closed == NULL)
        ...
        @endif
        @if ($data->closed == NULL && $data->total_plan >= $data->total_actual)
