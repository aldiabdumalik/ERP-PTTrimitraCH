<div class="btn-group dropright">
    ...
    <div class="dropdown-menu">
        <a class="dropdown-item text-primary thp-act-view" href="javascript:void(0)" data-thp="{{ $data->id_thp }}" data-date="{{ $data->thp_date }}" data-prod="{{ $data->production_code }}"><i class="fa fa-eye"></i> View</a>
        @if ($data->closed == NULL)
        <a class="dropdown-item text-warning thp-act-edit" href="javascript:void(0)" data-thp="{{ $data->id_thp }}" data-date="{{ $data->thp_date }}" data-prod="{{ $data->production_code }}"><i class="fa fa-pencil"></i> Edit</a>
        @endif
        @if ($data->closed == NULL)
