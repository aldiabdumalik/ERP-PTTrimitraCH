<div class="form-row align-items-center mb-1">
    ...
    <div class="col-10">
        <div class="row no-gutters">
            <div class="col-4">
                <input type="text" name="iparts-index-customercode" id="iparts-index-customercode" class="form-control form-control-sm" placeholder="Press Enter..." autocomplete="off" required>
            </div>
            <div class="col-8">
