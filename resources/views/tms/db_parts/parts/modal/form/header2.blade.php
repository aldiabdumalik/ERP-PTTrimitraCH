<div class="form-row align-items-center mb-1">
    <div class="col-2">
        <label for="iparts-index-qty" class="auto-middle">Qty parts item*</label>
    </div>
    <div class="col-10">
        <input type="text" name="iparts-index-qty" id="iparts-index-qty" class="form-control form-control-sm" autocomplete="off" required>
    </div>
</div>
<div class="form-row align-items-center mb-1">
    <div class="col-2">
...
<div class="form-row align-items-center mb-1">
    ...
    <div class="col-10">
        <input type="text" name="iparts-index-spec" id="iparts-index-spec" class="form-control form-control-sm" autocomplete="off" required>
    </div>
</div>
<div class="form-row align-items-center mb-1">
    <div class="col-2">
