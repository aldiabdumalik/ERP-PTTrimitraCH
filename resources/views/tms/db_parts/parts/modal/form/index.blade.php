        ...
        <form id="iparts-form-index" action="javascript:void(0)">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Modal Parts</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-row" style="font-size: 11px;">
                        ...
                        <div class="col-xl-5 border-left">
                            @include('tms.db_parts.parts.modal.form.header1')
                        </div>
                        <div class="col-xl-5 border-left border-right">
                            @include('tms.db_parts.parts.modal.form.header2')
                        </div>
                        <div class="col-xl-2 border-left">
                            @include('tms.db_parts.parts.modal.form.header3')
                        </div>
                    </div>
                </div>
