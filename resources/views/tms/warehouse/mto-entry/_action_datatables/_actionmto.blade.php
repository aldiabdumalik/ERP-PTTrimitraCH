...
<a href="#" data-toggle="tooltip" style="color: rgb(36, 100, 184);" row-id="{{ $model->id_mto }}" data-id="{{ $model->mto_no }}" data-target="{{$model->posted}}" data-placement="top" title="Posted" class=" posted"> <i class="fa fa-paper-plane"></i></a>
