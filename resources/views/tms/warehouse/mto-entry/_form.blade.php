    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                    <input class="form-control form-control-sm" value="{{ Auth::user()->UserID }}" name="staff" type="text" id="STAFF" disabled>
                    </div>  
                </div>
            </div> 
        </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <input class="form-control form-control-sm"  value="{{ $getDate1 }}"  type="text" name="period" id="period" required value="{{ $getDate1 }}">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <input class="form-control form-control-sm" type="text" value="{{ $getDate }}"  name="vperiod" value="{{ $getDate }}" id="VPERIOD" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" name="itemcode" type="text" name="from-wh-branch"  required
                                 onkeydown="keyPressed(event)" id="ITEMCODE" aria-describedby="" placeholder="Cari Itemcode">
