...
<div class="form-row align-items-center mb-1">
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-subtotal" id="custinv-create-subtotal" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-cndisc" id="custinv-create-cndisc" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
</div>
<div class="form-row align-items-center mb-1">
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-vat" id="custinv-create-vat" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-total" id="custinv-create-total" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
</div>
<div class="form-row align-items-center mb-1">
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-payment" id="custinv-create-payment" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-row align-items-center">
            ...
            <div class="col-8">
                <input type="text" name="custinv-create-balance" id="custinv-create-balance" class="form-control form-control-sm readonly-first" readonly>
            </div>
        </div>
    </div>
</div>